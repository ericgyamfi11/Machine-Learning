...
class SVDD():
    ...
    def train(self, data, label):
        ...
        _, accuracy, pred = self.test(data, label)
        ...
        if self.parameters["option"]["display"] == 'on':
            ...
            print('F1-Score: ', metrics.f1_score(label, pred))
            print('confusion_matrix: ', metrics.confusion_matrix(label, pred))
    ...
    def test(self, data, label):
        ...
        return distance, accuracy, predictedlabel
